program libraryTest
  ...
  ! open(unit=1,file='test/data/test_jn.dat',status='old')
  ! read(1,*) sfTestsN
  ...
  ! open(unit=1,file='test/data/test_yn.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testBesselN(sfTestsN), testBesselX(sfTestsN), testBessel(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testBesselN(i), testBesselX(i), testBessel(i)
  ...
  ! open(unit=1,file='test/data/test_in.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testBesselN(sfTestsN), testBesselX(sfTestsN), testBessel(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testBesselN(i), testBesselX(i), testBessel(i)
  ...
  ! open(unit=1,file='test/data/test_kn.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testBesselN(sfTestsN), testBesselX(sfTestsN), testBessel(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testBesselN(i), testBesselX(i), testBessel(i)
  ...
  ! open(unit=1,file='test/data/test_sphjn.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testBesselN(sfTestsN), testBesselX(sfTestsN), testBessel(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testBesselN(i), testBesselX(i), testBessel(i)
  ...
  ! open(unit=1,file='test/data/test_sphyn.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testBesselN(sfTestsN), testBesselX(sfTestsN), testBessel(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testBesselN(i), testBesselX(i), testBessel(i)
  ...
  ! open(unit=1,file='test/data/test_airyA.dat',status='old')
  ! read(1,*) sfTestsN
  ...
  ! open(unit=1,file='test/data/test_airyB.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testAiryX(sfTestsN), testAiry(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testAiryX(i), testAiry(i)
  ...
  ! open(unit=1,file='test/data/test_err.dat',status='old')
  ! read(1,*) sfTestsN
  ...
  ! open(unit=1,file='test/data/test_errc.dat',status='old')
  ! read(1,*) sfTestsN
  ! allocate(testErrX(sfTestsN), testErr(sfTestsN))
  ! do i=1,sfTestsN
  !   read(1,*) testErrX(i), testErr(i)
  ...
  ! call system_clock(t1, clock_rate, clock_max)
  ! do i=1, sfTestsN
  !   sfSumDiff = sfSumDiff+abs(errfc(testErrX(i))-testErr(i))
  ! end do
  ! call system_clock(t2, clock_rate, clock_max)
  ! write(*,'(3x,2(1x,a,1x,es16.8))') 'Total Error =', sfSumDiff, 'Average Error =', sfSumDiff/dble(sfTestsN)
  ! write(*,'(4x,a,1x,i0,1x,a,1x,es12.5,1x,a)') 'Time for ', sfTestsN, 'numbers =', dble(t2-t1)/dble(clock_rate), 'sec'
  ...
  ! open(unit=1,file='test/data/test_beta.dat',status='old')
  ! read(1,*) sfTestsN
  ...
  ! open(unit=1,file='test/data/test_incbeta.dat',status='old')
  ! read(1,*) sfTestsN
