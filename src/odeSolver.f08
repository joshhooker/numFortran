...
contains
  ...
  function rk1AdaptStepCmplxC(f,nF,a,b,y0,nC,consts)
    ...
    real(dp) :: xni, yni(nF), kci(nF), kcip(nF), ai(6),bi(6,6),ci(6),cip(6), rk1AdaptStepCmplxC(nF)
  ...
  subroutine rk1AdaptStepSetupConstants(ai,bi,ci,cip)
    ...
    ai(1:6) = 0.d0; bi(1:6,1:6) = 0.d0; ci(1:6) = 0.d0; cip(1:6) = 0.d0
    ai(1) = 0.d0; ai(2) = 1.d0/5.d0; ai(3) = 3.d0/10.d0; ai(4) = 3.d0/5.d0; ai(5) = 1.d0; ai(6) = 7.d0/8.d0
    bi(2,1) = 1.d0/5.d0; bi(3,1) = 3.d0/40.d0; bi(3,2) = 9.d0/40.d0; bi(4,1) = 3.d0/10.d0; bi(4,2) = -9.d0/10.d0
    bi(4,3) = 6.d0/5.d0; bi(5,1) = -11.d0/54.d0;bi(5,2) = 5.d0/2.d0; bi(5,3) = -70.d0/27.d0; bi(5,4) = 35.d0/27.d0
    bi(6,1) = 1631.d0/55296.d0; bi(6,2) = 175.d0/512.d0; bi(6,3) = 575.d0/13824.d0; bi(6,4) = 44275.d0/110592.d0
    bi(6,5) = 253.d0/4096.d0
    ci(1) = 37.d0/378.d0; ci(2) = 0.d0; ci(3) = 250.d0/621.d0; ci(4) = 125.d0/594.d0; ci(5) = 0.d0; ci(6) = 512.d0/1771.d0
    cip(1) = 2825.d0/27648.d0; cip(2) = 0.d0; cip(3) = 18575.d0/48384.d0; cip(4) = 13525.d0/55296.d0
    cip(5) = 277.d0/14336.d0; cip(6) = 1.d0/4.d0
